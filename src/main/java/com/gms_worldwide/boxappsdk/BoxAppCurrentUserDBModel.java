 ...
 */
class BoxAppCurrentUserDBModel implements Serializable {
...
// id is generated by the database and set on the object default (id = 1) for current user
    ...
    public int id = BoxAppConstants.CurrentUserIdInDb;
    ...
    /**
     * Instantiates a new Box app current user db model.
     */
    public BoxAppCurrentUserDBModel() {
     ...
     * @param id the id
     */
    public BoxAppCurrentUserDBModel(int id) {
        this.id = id;
    }
     ...
     */
    public BoxAppCurrentUserDBModel(int uniqAppDeviceId, String gcmTokenId, long phone, String email,
     ...
     * @param created_date               the created date
     */
    public BoxAppCurrentUserDBModel(long uniqAppDeviceId, String gcmTokenId, long phone,
     ...
     * Update user info.
     *
     * @param userProfileResponseModel the user profile response model
     */
    public void updateUserInfo(UserProfileResponseModel userProfileResponseModel) {
        this.uniqAppDeviceId = userProfileResponseModel.getUniqAppDeviceId();
        this.phone = userProfileResponseModel.getPhone();
        this.email = userProfileResponseModel.getEmail();
        this.latitude = userProfileResponseModel.getLatitude();
        this.longitude = userProfileResponseModel.getLongitude();
        this.fio = userProfileResponseModel.getFio();
        this.region = userProfileResponseModel.getRegion();
        this.city = userProfileResponseModel.getCity();
        this.sex = userProfileResponseModel.getSex();
        this.age = userProfileResponseModel.getAge();
        this.ads_source = BoxAppTools.integerArrayToString(userProfileResponseModel.getAds_source());
        this.interests = BoxAppTools.integerArrayToString(userProfileResponseModel.getInterests());
        this.allowed_receive_push = userProfileResponseModel.getAllowed_receive_push() == 1;
        this.created_date = userProfileResponseModel.getCreated_date();
    }
    ...
    public UserProfileModel getUserProfileModel() {
        return new UserProfileModel(uniqAppDeviceId, phone, email,
                ...
                BoxAppTools.converStringToIntegerArray(interests),
                BoxAppTools.converStringToIntegerArray(ads_source), created_date);
    }
