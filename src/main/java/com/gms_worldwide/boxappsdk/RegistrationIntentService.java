...
public class RegistrationIntentService extends IntentService {
    ...
    private static final String TAG = "com.gms_worldwide.boxappsdk.RegIntentService";
    ...
    static final String ACTION_START_IF_REQUIRED =
            "com.gms_worldwide.boxappsdk.RegistrationIntentService.startIfRequired";
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        try {
            ...
            String token = instanceID.getToken(BoxAppPlugins.get().getProjectId(),
                    GoogleCloudMessaging.INSTANCE_ID_SCOPE, null);
            // [END get_token]

            BoxAppGcmTokenSender.sendRegistrationToServer(token);
            //BoxAppPlugins.get().setGcmToken(token);
            currentUserDBModel.setGcmTokenId(token);
            BoxAppPlugins.get().getDatabaseHelper().updateCurrentUser(currentUserDBModel);
    ...
    static void startServiceIfRequired(Context context) {
        ...
        ServiceUtils.runIntentInService(
                context, new Intent(RegistrationIntentService.ACTION_START_IF_REQUIRED), RegistrationIntentService.class);
